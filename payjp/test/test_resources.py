...
class PayjpObjectTests(PayjpUnitTestCase):
    def test_initializes_with_parameters(self):
        obj = payjp.resource.PayjpObject("foo", "bar", myparam=5, yourparam="boo")
    ...
    def test_repr(self):
        obj = payjp.resource.PayjpObject("foo", "bar", myparam=5)
...
class ChargeTest(PayjpResourceTest):
    ...
    def test_charge_list_create(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "post", "/v1/charges", DUMMY_CHARGE, None
        )
    ...
    def test_charge_list_retrieve(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/charges/ch_test_id", {}, None
        )
    ...
    def test_charge_list_retrieve_with_api_key_and_api_base(self):
        ...
        self.requestor_class_mock.assert_called_with(
            key="KEY", api_base="BASE", account=None
        )
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/charges/ch_test_id", {}, None
        )
    ...
    def test_create_with_source_param(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "post",
            "/v1/charges",
            {"amount": 100, "currency": "jpy", "source": "btcrcv_test_receiver"},
            None,
        )
...
class CustomerTest(PayjpResourceTest):
    ...
    def test_list_customers_with_api_key_and_api_base(self):
        ...
        self.requestor_class_mock.assert_called_with(
            "KEY", account=None, api_base="BASE"
        )
        self.requestor_mock.request.assert_called_with(
            "get",
            "/v1/customers",
    ...
    def test_create_customer(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "post",
            "/v1/customers",
            {"description": "foo bar", "card": DUMMY_CARD},
            None,
        )
...
class CustomerSubscriptionTest(PayjpResourceTest):
    ...
    def test_list_customer_subscription(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/customers/cus_foo/subscriptions", {}, None
        )
    ...
    def test_retrieve_customer_subscription(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/customers/cus_foo/subscriptions/sub_cus", {}, None
        )
...
class SubscriptionTest(PayjpResourceTest):
    def test_create_subscription(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "post",
            "/v1/subscriptions",
            {"customer": customer.id, "plan": DUMMY_PLAN["id"]},
            None,
        )
    ...
    def test_delete_subscriptions(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "delete", "/v1/subscriptions/sub_delete", {}, None
        )

    def test_update_subscription(self):
        sub = payjp.Subscription.construct_from(
            {"id": "sub_update", "customer": "cus_foo", "plan": "plan_foo"}, "api_key"
        )
    ...
    def test_pause_subscriptions(self):
        sub = payjp.Subscription.construct_from(
            {"id": "sub_delete", "customer": "cus_foo", "status": "active"}, "api_key"
        )
        sub.pause()
        self.requestor_mock.request.assert_called_with(
            "post", "/v1/subscriptions/sub_delete/pause", {}, None
        )
    ...
    def test_cancel_subscriptions(self):
        ...
        sub.cancel()
        self.requestor_mock.request.assert_called_with(
            "post", "/v1/subscriptions/sub_delete/cancel", {}, None
        )
...
class PlanTest(PayjpResourceTest):
    ...
    def test_delete_plan(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "delete", "/v1/plans/pl_delete", {}, None
        )
...
class RefundTest(PayjpResourceTest):
    ...
    def test_fetch_refund(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/charges/ch_get_refund/refunds/ref_get", {}, None
        )
    ...
    def test_list_refunds(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/charges/ch_get_refund/refunds", {}, None
        )
...
class TermTest(PayjpResourceTest):
    def test_list_terms(self):
        payjp.Term.all()
        self.requestor_mock.request.assert_called_with("get", "/v1/terms", {})

    def test_retrieve_term(self):
        payjp.Term.retrieve("term_foo")
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/terms/term_foo", {}, None
        )
...
class BalanceTest(PayjpResourceTest):
    ...
    def test_list_balances(self):
        payjp.Balance.all()
        self.requestor_mock.request.assert_called_with("get", "/v1/balances", {})

    def test_retrieve_balance(self):
        balance = payjp.Balance.retrieve("balance_foo")
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/balances/balance_foo", {}, None
        )
        ...
        self.requestor_mock.request.assert_called_with(
            "post", "/v1/statements/st_xxx/statement_urls", {}, None
        )
...
class ThreeDSecureRequestTest(PayjpResourceTest):
    ...
    def test_list_three_d_secure(self):
        ...
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/three_d_secure_requests", {}
        )

    def test_retrieve_three_d_secure(self):
        three_d_secure_request = payjp.ThreeDSecureRequest.retrieve(
            "three_d_secure_request_foo"
        )
        self.requestor_mock.request.assert_called_with(
            "get", "/v1/three_d_secure_requests/three_d_secure_request_foo", {}, None
        )
